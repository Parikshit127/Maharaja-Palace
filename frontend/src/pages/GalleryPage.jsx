    ...
    dining: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M12 3v18M8 3v3a4 4 0 004 4M8 3H6m10 0v3a4 4 0 01-4 4m4-7h2M3 21h18"
        />
      </svg>
    ),
    banquet: (
  ...
  const galleryImages = [
    {
      ...
      title: "Deluxe Suite",
      desc: "Luxurious comfort redefined",
    },
    {
      id: 2,
      category: "dining",
      ...
      title: "Fine Dining",
      desc: "Culinary excellence awaits",
    },
    {
      id: 3,
      category: "exterior",
    ...
    },
    {
      ...
      desc: "Global flavors, local charm",
    },
    {
      id: 7,
      category: "exterior",
    ...
    },
    {
      ...
      desc: "Where business meets luxury",
    },
    {
      id: 12,
      category: "exterior",
    ...
    <div className="bg-[#FBF9F4] min-h-screen overflow-x-hidden">
      ...
      <section className="relative py-32 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div
            className="bg-white/80 backdrop-blur-xl rounded-3xl p-12 border border-[#B8860B]/20 shadow-2xl"
            style={{
          ...
          >
            ...
            <p className="text-sm uppercase tracking-[0.4em] text-[#B8860B] mb-6">
              Explore Our Palace
            </p>
            <p className="text-xl text-[#4a4a4a] leading-relaxed font-light">
              Every corner of Maharaja Palace tells a story of heritage,
              craftsmanship, and timeless elegance. Our gallery captures the
              essence of royal living—from opulent suites to magnificent banquet
              halls.
            </p>
          </div>
        </div>
      ...
      <section ref={galleryRef} className="max-w-7xl mx-auto px-6 pb-32">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredImages.map((item, index) => (
            ...
            >
              <div
                className="relative w-full h-full transform-gpu transition-all duration-700 group-hover:scale-[1.02]"
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  <p className="royal-title text-3xl text-white mb-1 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 drop-shadow-lg">
                    {item.title}
                  </p>
                  <p className="text-white/80 text-sm font-light opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">
                    {item.desc}
                  </p>
                </div>
      ...
      {lightboxImage && (
        <div
          className="fixed inset-0 z-50 bg-[#FBF9F4]/98 backdrop-blur-xl flex items-center justify-center"
          onClick={closeLightbox}
        >
          <button
            className="absolute top-6 right-6 w-12 h-12 rounded-full bg-[#B8860B]/10 hover:bg-[#B8860B]/20 flex items-center justify-center text-[#B8860B] hover:text-[#8B6914] transition-all duration-300 z-50"
            onClick={closeLightbox}
          >
            <svg
              className="w-6 h-6"
          ...
          <button
            className="absolute left-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-white shadow-lg hover:bg-[#B8860B]/10 flex items-center justify-center text-[#B8860B] transition-all duration-300 z-50 border border-[#B8860B]/20"
            onClick={(e) => {
              e.stopPropagation();
              navigateLightbox(-1);
            }}
          ...
          <button
            className="absolute right-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-white shadow-lg hover:bg-[#B8860B]/10 flex items-center justify-center text-[#B8860B] transition-all duration-300 z-50 border border-[#B8860B]/20"
            onClick={(e) => {
              e.stopPropagation();
              navigateLightbox(1);
            }}
          ...
          <div
            className="max-w-6xl max-h-[85vh] flex flex-col items-center px-20"
            onClick={(e) => e.stopPropagation()}
          >
            <div
              className="relative overflow-hidden rounded-2xl shadow-2xl"
              style={{ boxShadow: "0 25px 80px rgba(184, 134, 11, 0.25)" }}
            >
              <img
            ...
            <div className="text-center mt-8 animate-fadeInUp">
              <h3 className="royal-title text-4xl text-[#2a2a2a] mb-2">
                {lightboxImage.title}
              </h3>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="royal-title text-5xl md:text-7xl text-white mb-8">
            Visit Maharaja Palace
          </h2>
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-12 font-light leading-relaxed">
            Pictures capture moments, but memories are made in person. Come
            experience the grandeur and hospitality that awaits you.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a
              href="/rooms"
              className="group relative px-12 py-5 overflow-hidden rounded-lg"
            >
            ...
            <a
              href="/contact"
              className="group relative px-12 py-5 border-2 border-white text-white hover:text-[#1a1a1a] font-semibold tracking-wider transition-all duration-500 overflow-hidden rounded-lg"
            >
