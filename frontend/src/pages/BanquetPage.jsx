      ...
      {!loading && halls.length === 0 && (
        <div className="text-center py-20">
          <p className="text-gray-600 font-serif text-lg">
            No banquet halls available at the moment.
          </p>
        </div>
      )}

      {/* Show content only when not loading and halls exist */}
      {!loading && halls.length > 0 && (
        <>
          {/* ========= CAROUSEL ========= */}
          <section
                  ...
                  <div className="p-5 sm:p-7 transition-all duration-500 group-hover:bg-gradient-to-b group-hover:from-white group-hover:to-gold/5">
                    ...
                    <div className="flex items-center gap-4 sm:gap-6 text-xs uppercase tracking-wider text-gray-600">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gold">
                          {halls[currentIndex].areaSqFt.toLocaleString()} Sq.
                          Ft.
                        </p>
                      </div>
                    </div>
                            ...
                            {isCenter && (
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  navigate(
                                    `/banquet-booking?hallId=${hall.id}`
                                  );
                                }}
          ...
          <section className="max-w-5xl mx-auto px-6 py-20 text-center font-royal">
            ...
            <p className="text-gray-600 font-serif text-lg leading-relaxed mb-16 max-w-3xl mx-auto">
              A glimpse into the graceful experiences shared by our guests,
              echoing the warmth, elegance, and royal hospitality of Maharaja
              Palace.
            </p>
